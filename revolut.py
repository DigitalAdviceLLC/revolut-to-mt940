...
EXCPECT_HEADERS = [
    'Date started (UTC)', 'Date completed (UTC)', 'Date started (Europe/Zurich)', 'Date completed (Europe/Zurich)',
    'ID', 'Type', 'Description', 'Reference',
    'Payer', 'Card number', 'Orig currency', 'Orig amount',
    'Payment currency', 'Amount', 'Fee', 'Balance',
    'Account', 'Beneficiary account number', 'Beneficiary sort code or routing number', 'Beneficiary IBAN',
    'Beneficiary BIC'
]
...
class RevolutCsvReader:
    ...
    def _parse_transaction(self, row):
        ...
        _0, completed_date_str, _2, _3, _4, _5, name, description, _8, _9, _10, \
        _11, _12, amount_str, fee_str, balance_str, _16, _17, _18, iban, _20 \
            = row
